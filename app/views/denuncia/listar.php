                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            ?>
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-700">Usuário #<?= $denuncia->getIdDenunciado() ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-700"><?= htmlspecialchars($denuncia->getMotivo(), ENT_QUOTES, 'UTF-8') ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-700"><?= htmlspecialchars(date('d/m/Y H:i', strtotime($denuncia->getData())), ENT_QUOTES, 'UTF-8') ?></td>
                                    <td class="px-6 py-4">
