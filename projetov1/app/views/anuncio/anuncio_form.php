...
<main class="flex-1">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
            ...
            <form method="POST" action="<?= $modoEdicao ? '/anuncios/editar/submit' : '/anuncios/criar/submit' ?>" class="space-y-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="titulo" 
                        required
                        value="<?= $anuncio ? htmlspecialchars($anuncio->getTitulo(), ENT_QUOTES, 'UTF-8') : '' ?>"
                ...
                <div>
                    ...
                    ><?= $anuncio ? htmlspecialchars($anuncio->getDescricao(), ENT_QUOTES, 'UTF-8') : '' ?></textarea>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            name="localizacao" 
                            required
                            value="<?= $anuncio ? htmlspecialchars($anuncio->getLocalizacao(), ENT_QUOTES, 'UTF-8') : '' ?>"
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            step="0.01"
                            min="0"
                            value="<?= $anuncio ? number_format($anuncio->getRemuneracao(), 2, '.', '') : '' ?>"
                            placeholder="0.00"
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="TEMPORARIO" <?= $anuncio && $anuncio->getTipoServico() === 'TEMPORARIO' ? 'selected' : '' ?>>Temporário</option>
                            <option value="FIXO" <?= $anuncio && $anuncio->getTipoServico() === 'FIXO' ? 'selected' : '' ?>>Fixo</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            id="duracao" 
                            name="duracao" 
                            value="<?= $anuncio ? htmlspecialchars($anuncio->getDuracao(), ENT_QUOTES, 'UTF-8') : '' ?>"
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            name="data" 
                            required
                            value="<?= $anuncio ? htmlspecialchars($anuncio->getData(), ENT_QUOTES, 'UTF-8') : '' ?>"
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            value="<?= $anuncio && $anuncio->getPrazoCandidatura() ? htmlspecialchars($anuncio->getPrazoCandidatura(), ENT_QUOTES, 'UTF-8') : '' ?>"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        >
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ><?= $anuncio ? htmlspecialchars($anuncio->getObservacoes() ?? '', ENT_QUOTES, 'UTF-8') : '' ?></textarea>
                </div>
