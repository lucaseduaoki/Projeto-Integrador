    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center gap-8">
                <a href="<?= URL_BASE ?>/vagas" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">Vagas</a>
        ...
        <div id="mobileMenu" class="hidden md:hidden pb-4 border-t border-gray-100">
            <a href="<?= URL_BASE ?>/vagas" class="block px-4 py-2 text-gray-700 hover:bg-gray-50">Vagas</a>
